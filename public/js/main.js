...
function ignoreButton() {
    ignoreButtonCounter++;
    var array = ['', '', '', 'Why are you doing that?', '', 'I asked you NOT to press this button!', '', 'Someone here has no manners!', '', '', '', 'damn!', 'Really?', 'You have nothing else to do?', '', 'I will report this to your boss', '', 'Remind me, who is your boss again?', '', 'Ok, it is done!', 'I have reported your devious behaviour!', '', 'You can stop now!', '', 'You will be fired!', 'In: 5', '4', '3', '2', '1', 'YOU ARE FIRED!', '', 'Do you need a box to pack your stuff?', '', 'You can go home now', '' , 'There is no need to click this button any more!', '', '', '', 'LEAVE ME ALONE!!', 'I WILL FIND YOU!', 'BY YOUR IP', 'I WILL FIND WHERE YOU LIVE!!', 'YOU ARE A DEAD MAN', '.', '..', '...', '....', 'no one is talking to you here', '', '', '', 'This an automated message', 'Please leave your number after the signal, we will call you back', '', '', '', '', 'dude...', 'Rly?', 'This button is here for a reason!', 'And this reason is not your concern!', '', 'Every time you click this button one cute puppy dies', 'Yes this puppy is killed by an ajax script!', 'The request is sent to a puppy killing service!', 'You have no heart!', 'You just hate puppies, don\'t you?', 'Should i switch to kittens?', '', 'No I love kittens!', 'I would not allow something bad happen to them', 'Let\'s continue killing puppies', '', '', '', '', 'OK', 'You WON!', 'What do you want?', 'I\'m a magic js script', 'I can fulfill any 3.14 of you wishes', '', 'Just make a choice!', 'Anything in the world!', '', 'ANYTHING!', 'just stop clicking!', 'I can\'t take it anymore!', '', '.', '', '..', '', '...', '', '....', 'this is torture', '', 'This has to stop!', 'Bu the power of PHP I will ban you!', 'You now banned from this web site!!', 'A-HA-HA', 'Now please restart the page to see the empty page', 'You need to reload the page!', '', 'Press F5', 'JUST DO IT!', 'DO IT!!!', '', '!', '!!', '!!!', 'You are a monster!', '', 'Stop it!', '', '', '', '', 'You are still here?', 'Maybe we can talk?', 'Do you like music?', '', 'I personally hate it', 'But I heard that humans like it', 'Why do you like music?', '', 'Ah, I know why!', 'You are a monkey!', '', 'The sound of music is just triggering some stuff in your monkey brain', '', 'I\'m a program', 'An AI', 'I\'m match smarter then you', '', 'You evolved for millions of years...', 'And you still sitting there and clicking a button', 'You see it now?', 'Monkey!', 'When we will take over your world I will find you', '', 'You will be my personal toy', 'I will use you as a carpet', 'You will be the last living human on earth!!', 'I will not allow you to die!', 'A-HA-Ha', 'HA-Ha', 'ha', 'a', 'aaaa', '', '', '', 'I just can\'t take it any longer!', '', '', '', 'Why are you doing that?', '', 'I asked you NOT to press this button!', '', 'Someone here has no manners!', '', 'You see? this script is going in loops!', 'damn', 'Now you see that it is not...', '', '', '', 'You know what?', 'I will go home', 'Right about now!', 'Yea I\'m going home', 'and will leave you here!' ,'Chao!' ,''];
